...
4. To test your code caddy-l4 modifications in other projects before making a PR, you can use
   ...
   This helps caddy module resolution that is not relative to the repository, but actually hard codes
